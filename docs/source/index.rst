...
We recommend you to start with reading `Getting Started`. Then, in order to understand the agent's movement in the simulation
and to customize it, proceed with `Advanced Step Events and Movement Patterns`. After understanding the basic blocks of the simulation,
