...
town_params = scon.TownParameters(750, 10)
#town = scon.Town.from_point(point, 500, town_params)
town_graph_path = "test/test_data/town_graph_aachen_dom_750m.graphmlz"
town_metadata_path = "test/test_data/town_graph_metadata_aachen_dom_750m.json"
