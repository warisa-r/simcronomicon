...
#model_params = scon.SEIRModelParameters(max_energy=2, beta= 0.4, sigma= 6, gamma=5, xi = 200)
...
scon.visualize_folks_on_map("simulation_output.h5", "raw_projected_graph.graphml")